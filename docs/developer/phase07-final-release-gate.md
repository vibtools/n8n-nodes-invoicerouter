...
Phase 07 combines the automated pre-release publication gate with the reviewed post-publication live-acceptance gate for InvoiceRouter v2.1.3. It does not redesign the frozen eight-node architecture and does not grant production approval merely because unit tests pass.

## Frozen target

- Package: `n8n-nodes-invoicerouter@2.1.3`
