...
if (pkg.version !== '2.1.3') errors.push('package.json must use approved release version 2.1.3.');
...
if (!changelogSource.includes(`## ${pkg.version} - 2026-08-05`)) errors.push('CHANGELOG.md must contain the dated 2.1.3 release entry.');
